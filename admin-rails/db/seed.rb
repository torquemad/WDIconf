...
Talk.create([{ speaker_id: 7, title: 'Stop working and get rich, you idiot!', blurb: 'Stop working and get rich, you idiot!', description: 'Gone are the days of trading time for money. I\'ll show you how to leverage the Internet and earn passive income.', date: Time.utc(2015, 05, 22, 11, 00), limit: 30, duration: 15 }]);
# ----------------------------------------------------------
#                   Nick Pateman: id=8
# ----------------------------------------------------------
