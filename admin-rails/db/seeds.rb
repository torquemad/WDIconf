...
Talk.create([{ speaker_id: 3, title: 'Why Microsoft Windows is a superior development environment', blurb: 'Why Microsoft Windows is a superior development environment', description: 'How to cure premature optimisation with benchmarking. Benchmarking, in-line C and external executables.', date: Time.utc(2015, 05, 22, 10, 45), limit: 30, duration: 15 }])
# ----------------------------------------------------------
#                   Mike Goodwin: id=4
# ----------------------------------------------------------
...
Talk.create([{ speaker_id: 6, title: 'Stop working and get rich, you idiot!', blurb: 'Stop working and get rich, you idiot!', description: 'Gone are the days of trading time for money. I\'ll show you how to leverage the Internet and earn passive income.', date: Time.utc(2015, 05, 22, 10, 45), limit: 30, duration: 15 }])
# ----------------------------------------------------------
#                   Louis Moore: id=7
# ----------------------------------------------------------
...
Talk.create([{ speaker_id: 7, title: 'Solving Your IRL Tech Problems', blurb: 'Solving Your IRL Tech Problems', description: 'A couple of weeks ago, I solved my first real-life problem using the software dev skills from WDI (it\'s an awesome feeling). Join me in a short interactive demo, and lets discuss some current problems that you could tackle at home.', date: Time.utc(2015, 05, 22, 11, 00), limit: 30, duration: 15 }])
# ----------------------------------------------------------
#                   Nick Pateman: id=8
# ----------------------------------------------------------
...
Talk.create([{ speaker_id: 8, title: 'Panoramas in Photoshop', blurb: 'Panoramas in Photoshop', description: 'Something tech, not code. Seeing the magic of photoshop.', date: Time.utc(2015, 05, 22, 11, 30), limit: 30, duration: 15 }])
# ----------------------------------------------------------
#                   Beta Ngadiman: id=9
# ----------------------------------------------------------
...
Talk.create([{ speaker_id: 9, title: 'I have no idea what I am doing!', blurb: 'I have no idea what I am doing!', description: 'Design on the World Wide Web!', date: Time.utc(2015, 05, 22, 11, 45), limit: 30, duration: 15 }])
# ----------------------------------------------------------
...
Talk.create([{ speaker_id: 11, title: 'Design trends through the years', blurb: 'Design trends through the years', description: 'From Hotdog to Paralax, we take a walk down internet memory lane, and have a look into what\'s in store for the web.', date: Time.utc(2015, 05, 22, 12, 15), limit: 30, duration: 15 }])
