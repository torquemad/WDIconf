...
Talk.create([{ speaker_id: 3, title: 'Why Microsoft Windows is a superior development environment',badge: 'Tech', blurb: 'Why Microsoft Windows is a superior development environment', description: 'How to cure premature optimisation with benchmarking. Benchmarking, in-line C and external executables.', date: Time.utc(2015, 05, 22, 10, 45), limit: 30, duration: 15 }])
# ----------------------------------------------------------
#                   Mike Goodwin: id=4
# ----------------------------------------------------------
...
Talk.create([{ speaker_id: 4, title: 'Discussions About (Not Quite) Dead Languages; Part 1: COBOL', badge: 'BE',blurb: 'Discussions About (Not Quite) Dead Languages; Part 1: COBOL', description: 'We begin our discussion of programming languages for which, despite public perception, the last rites have not yet been read. WS-NOT-QUITE-DEAD-LANGUAGES[0] => COBOL.', date: Time.utc(2015, 05, 22, 10, 15), limit: 30, duration: 15 }])
# ----------------------------------------------------------
#                   JC: id=5
# ----------------------------------------------------------
...
Talk.create([{ speaker_id: 5, title: 'Song Creation Lighweight',badge: 'FE', blurb: 'Song Creation Lighweight', description: 'It\'s always fun to create a song or customize karaoke demo if it\'s as simple as creating it on the fly on a web browser. Introducing Hookpad, demo and a bit of technology used to build it.', date: Time.utc(2015, 05, 22, 10, 30), limit: 30, duration: 15 }])
# ----------------------------------------------------------
#                   Matt Cameron: id=6
# ----------------------------------------------------------
User.create([{ access_level_id: 3, email: 'matt.c@codyperry.com', login_type:1, password: '123', password_salt: 'abcde' }])
Speaker.create([{ user_id: 6, name: 'Matt Cameron', blurb: 'I&#40;m a full stack web developer with a burning love for application development and architecture, coding and high tech funware!', remote_image_url: 'https://files.slack.com/files-pri/T0351JZQ0-F04V0CWJT/phil.jpg'}])
Talk.create([{ speaker_id: 6, title: 'Stop working and get rich, you idiot!',badge: 'Tech', blurb: 'Stop working and get rich, you idiot!', description: 'Gone are the days of trading time for money. I\'ll show you how to leverage the Internet and earn passive income.', date: Time.utc(2015, 05, 22, 10, 45), limit: 30, duration: 15 }])
# ----------------------------------------------------------
#                   Louis Moore: id=7
# ----------------------------------------------------------
...
Talk.create([{ speaker_id: 7, title: 'Solving Your IRL Tech Problems',badge: 'BE', blurb: 'Solving Your IRL Tech Problems', description: 'A couple of weeks ago, I solved my first real-life problem using the software dev skills from WDI (it\'s an awesome feeling). Join me in a short interactive demo, and lets discuss some current problems that you could tackle at home.', date: Time.utc(2015, 05, 22, 11, 00), limit: 30, duration: 15 }])
# ----------------------------------------------------------
#                   Nick Pateman: id=8
# ----------------------------------------------------------
...
Talk.create([{ speaker_id: 8, title: 'Panoramas in Photoshop', badge: 'FE', blurb: 'Panoramas in Photoshop', description: 'Something tech, not code. Seeing the magic of photoshop.', date: Time.utc(2015, 05, 22, 11, 30), limit: 30, duration: 15 }])
# ----------------------------------------------------------
#                   Beta Ngadiman: id=9
# ----------------------------------------------------------
...
Talk.create([{ speaker_id: 9, title: 'I have no idea what I am doing!',badge: 'FE', blurb: 'I have no idea what I am doing!', description: 'Design on the World Wide Web!', date: Time.utc(2015, 05, 22, 11, 45), limit: 30, duration: 15 }])
# ----------------------------------------------------------
...
Talk.create([{ speaker_id: 11, title: 'Design trends through the years', badge: 'FE',blurb: 'Design trends through the years', description: 'From Hotdog to Paralax, we take a walk down internet memory lane, and have a look into what\'s in store for the web.', date: Time.utc(2015, 05, 22, 12, 15), limit: 30, duration: 15 }])
